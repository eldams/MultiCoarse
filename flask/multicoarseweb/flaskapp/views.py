...
def result():
    ...
    lstmots += '<th style="background-color:DodgerBlue;">Catégorie </th>'
    ...
    for mot in mots:
        ...
        lstmots += '<td style="background-color:DodgerBlue;">'+ mot[2]+ '</td>'
        lstmots += '<td style="background-color:Tomato;">'+  mot[3]+ '</td>'
        lstmots += '<td style="background-color:hsla(9, 100%, 64%, 0.5);">' +  mot[4]+ '</td>'
        lstmots += '<td style="background-color:rgb(255, 165, 0);">'+  mot[5]+ '</td>'
        lstmots += '</tr>'
    lstmots += '</table>'
    return lstmots 
